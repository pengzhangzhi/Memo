...
namespace MEMO
{
    public partial class TranslateForm : Form
    {
        ...
        public class Translator
        {
            ...
            public Translator(string q,string to,string appId,string secretKey)
            {
                this.q = q;
                this.to = to;
                this.appId = appId;
            ...
            public string Translate()
            {
                ...
                string sign = EncryptString(appId + this.q + salt + secretKey);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Translator translator = new Translator(q,to, appId, secretKey);
            MessageBox.Show(translator.from);
            MessageBox.Show(translator.to);
            MessageBox.Show(translator.q);
